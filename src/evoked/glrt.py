...
def build_template_glrt(
    ...
    return template_array, contributing_keys, noise_variance, mad_threshold, slope_transform
...
def fit_template_glrt(
    ...
    """
    template_arr, contributing_keys, noise_variance, mad_threshold, slope_transform = template_package
